...
//alert('in controller');
  ...
  $http({
  method:'POST',
  url:'http://server-demo12.apps.ose.canopy-cloud.com/login',
  data:login,
...
var signup={
  ...
  $http({
  method:'POST',
  url:'http://server-demo12.apps.ose.canopy-cloud.com/registerEmployee',
  data:signup,
  header:{'Content-Type':'application/json'}
  }).success(function (data, status, headers, config) {
...
//alert('in showemployee controller !!! READY TO fetch');
  ...
  $http({
  method:'GET',
  url:'http://server-demo12.apps.ose.canopy-cloud.com/employees',
...
$http({
  method:'DELETE',
  url:'http://server-demo12.apps.ose.canopy-cloud.com/delete/'+id
...
$http({
  method:'GET',
  url:'http://server-demo12.apps.ose.canopy-cloud.com/getEmployeeInfo/'+uid
...
var employeeupdatedata={
  ...
  $http({
  method:'POST',
  url:'http://server-demo12.apps.ose.canopy-cloud.com/updateEmployee',
